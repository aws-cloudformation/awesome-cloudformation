...
- [OpenJS Architect](https://github.coma/architect/architect): Generate AWS CloudFormation and AWS Serverless Application Model friendly code from a very terse high level manifest file written in `JSON`, `YAML`, `TOML` or `.arc` format
